<?php class_exists('lib\Template') or exit; ?>
<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8">
...
<body>
    ...
    <div class="navigation">
        ...
        <ul>
            ...
            <li class="list<?php if($active == 'home'): ?> active<?php endif; ?>">
                <a href="/" style="--clr: #0000a0">
                    <span class="icon" title="Audios"><ion-icon name="home-outline"></ion-icon></span>
                    <span class="text">Inicio</span>
                </a>
            </li>
            <li class="list<?php if($active == 'audio'): ?> active<?php endif; ?>">
            ...
            <li class="list<?php if($active == 'book'): ?> active<?php endif; ?>">
            ...
            <li class="list<?php if($active == 'setting'): ?> active<?php endif; ?>">
    ...
    <div class="container home">
        <h1>Inicio</h1>
        <p>Bienvenido al Gestor Multimedia</p>
        <img src="assets/img/main.png" alt="Gestor Multimedia">
    </div>
