...
class Utils
{
    ...
    public static function getBase64FromFileImage($file)
    {
      ...
      $base64 = 'data:image/' . ((strtolower($type) == 'svg') ? 'svg+xml' : $type) . ';base64,';
     ...
     * this equates to a luminance of 170. Ex. if (get_avg_luminance > 170) --> Dark else --> Light
     * 
     * @param String $filename Full path to file image
     * @param Integer $num_samples Less number more precise (10 default)
     * 
     * @return Integer Luminance averange
     */
